...
const name = 'litecoin-circle-solid/noir'

registerIcon(
  name,
  `<svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M1.25 12C1.25 6.063 6.063 1.25 12 1.25S22.75 6.063 22.75 12 17.937 22.75 12 22.75 1.25 17.937 1.25 12Zm9.25-5.75a.75.75 0 0 1 .75.75v3.957l1.445-.642a.75.75 0 0 1 .61 1.37l-2.055.913v3.652h4.25a.75.75 0 0 1 0 1.5h-4.4a1.35 1.35 0 0 1-1.35-1.35v-3.135l-.945.42a.75.75 0 0 1-.61-1.37l1.555-.691V7a.75.75 0 0 1 .75-.75Z" clip-rule="evenodd"/></svg>`
)

export function LitecoinCircleSolid(props: IconProps) {
  return <Icon name={name} {...props} />
}

LitecoinCircleSolid.prototype.name = name
