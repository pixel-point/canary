...
registerIcon(
  name,
  `<svg width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 4L8 20" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></svg>`
)
