...
interface PlaygroundPullRequestChangesSettingsProps {
  loadState: string
  setLoadState: (state: string) => void
}

const PlaygroundPullRequestChangesSettings: React.FC<PlaygroundPullRequestChangesSettingsProps> = ({
  loadState,
  setLoadState
}) => {
  return (
...
export default PlaygroundPullRequestChangesSettings
