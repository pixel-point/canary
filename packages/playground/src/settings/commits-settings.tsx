...
interface PlaygroundCommitsSettingsProps {
  loadState: string
  setLoadState: (state: string) => void
}

const PlaygroundCommitsSettings: React.FC<PlaygroundCommitsSettingsProps> = ({ loadState, setLoadState }) => {
  return (
...
export default PlaygroundCommitsSettings
