 ...
 * Generated on Wed, 19 Mar 2025 07:15:44 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/default.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-200) l c h / 0.12)",
          $description:
        ...
        state: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-green-200) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-500) l c h / 0.2)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-500) l c h / 0.25)",
        $description:
