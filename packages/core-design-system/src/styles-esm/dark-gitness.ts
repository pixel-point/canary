 ...
 * Generated on Wed, 19 Mar 2025 07:15:42 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/dark/default.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  border: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-850) l c h / 0.7)",
      $description:
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-300) l c h / 0.2)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-500) l c h / 0.1)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-300) l c h / 0.2)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-500) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(90.23% 26.34 77.18) 0%, lch(72% 46.72 350.11) 35%, lch(61.28% 80.51 307.53) 65%, lch(74.15% 29 241) 100%)",
          $description:
    ...
    dropdown: {
      ...
      item: {
        title: {
          ...
          name: "cn-component-dropdown-item-title",
          attributes: {
            category: "component",
            type: "dropdown",
            item: "item",
          ...
          path: ["component", "dropdown", "item", "title"],
        },
        description: {
          $type: "color",
          $value: "lch(74.37% 4.52 285.5)",
          ...
          name: "cn-component-dropdown-item-description",
          attributes: {
            category: "component",
            type: "dropdown",
            item: "item",
          ...
          path: ["component", "dropdown", "item", "description"],
        },
        delete: {
          text: {
            $type: "color",
      ...
      arrow: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "linear-gradient(90deg, lch(100% 0 134.54) 0%, lch(63.4% 48.44 281.2) 50%, lch(74.37% 4.52 285.5) 100%)",
            $description:
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value:
        "0 0 0 2px lch(3.66% 1.93 285.7), 0 0 0 4px lch(85.99% 3.77 285.34)",
      $description:
