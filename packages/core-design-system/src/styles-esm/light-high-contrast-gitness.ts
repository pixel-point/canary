...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/high-contrast.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-300) l c h / 0.1)",
          $description:
      ...
      success: {
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-green-300) l c h / 0.15)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-green-300) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-400) l c h / 0.12)",
        $description:
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-400) l c h / 0.2)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-400) l c h / 0.25)",
        $description:
