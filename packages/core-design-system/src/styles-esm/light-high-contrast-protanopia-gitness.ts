 ...
 * Generated on Wed, 19 Mar 2025 07:15:57 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  border: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-200) l c h / 0.7)",
      $description:
    ...
    success: {
      ...
      $description:
        "Border color for success containers. Adjusted for protanopia using blue instead of green.\n\nCommon uses: Success alert borders, confirmation boundaries, completed state indicators.",
      filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  state: {
    hover: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.15)",
      $description:
    ...
    selected: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-400) l c h / 0.2)",
      $description:
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-400) l c h / 0.1)",
          $description:
    ...
    badge: {
      ...
      neutral: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-600) l c h / 0.6)",
          $description:
      ...
      success: {
        text: {
          ...
          $description:
            "Text color for success badges. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-400) l c h / 0.6)",
          $description:
            "Border color for success badges. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.1)",
          $description:
            "Background color for success badges. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
      ...
      danger: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-400) l c h / 0.6)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-200) l c h / 0.1)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-300) l c h / 0.1)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-300) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(53.21% 65.17 349.99) 35%, lch(50.99% 105.85 309.98) 65%, lch(65.49% 45.28 239) 100%)",
          $description:
    ...
    btn: {
      ...
      success: {
        text: {
          ...
          $value: "lch(27.25% 49.8 280.51)",
          $description:
            "Text color for success buttons. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.1)",
          $description:
            "Background color for success buttons. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        border: {
          ...
          $value: "lch(from var(--cn-colors-blue-400) l c h / 0.6)",
          $description:
            "Border color for success buttons. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-blue-300) l c h / 0.15)",
            $description:
              "Hover state background color for success buttons. Adjusted for protanopia using blue instead of green.",
            filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-blue-300) l c h / 0.25)",
            $description:
              "Active state background color for success buttons. Adjusted for protanopia using blue instead of green.",
            filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
      ...
      danger: {
        ...
        state: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-red-300) l c h / 0.25)",
            $description:
    ...
    dialog: {
      ...
      backdrop: {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-chrome-500) l c h / 0.5)",
        $description:
        ...
        delete: {
          ...
          state: {
            hover: {
              ...
              filePath:
                "design-tokens/mode/light/high-contrast-protanopia.json",
              isSource: true,
              original: {
                $extensions: {
                  "studio.tokens": {
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-400) l c h / 0.12)",
        $description:
          "Blue background highlighting newly added code lines. Adjusted for protanopia using blue instead of green.",
        filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-400) l c h / 0.2)",
        $description:
          "Background for line numbers of added code. Adjusted for protanopia using blue instead of green.",
        filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-400) l c h / 0.25)",
        $description:
          "Stronger emphasis color for specific character changes within added lines. Adjusted for protanopia using blue instead of green.",
        filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "del-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-red-400) l c h / 0.12)",
        $description:
      ...
      "del-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-red-400) l c h / 0.2)",
        $description:
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-red-400) l c h / 0.25)",
        $description:
    ...
    pipeline: {
      arrow: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "linear-gradient(90deg, lch(74.37% 4.52 285.5) 0%, lch(47.04% 69.94 279.78) 50%, lch(39.46% 8.98 286.89) 100%)",
            $description:
      ...
      card: {
        ...
        border: {
          $type: "color",
          $value:
            "radial-gradient(90% 100% at 15% 0%,lch(90.71% 0.38 284.93) 10%, lch(81.33% 4.52 285.46) 75%)",
          $description:
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "radial-gradient(604% 142% at 0% 0%, lch(54.81% 69.74 52.27) 0%, lch(from var(--cn-colors-chrome-300) l c h / 0.4) 30%, lch(54.81% 69.74 52.27) 100%)",
            $description:
        ...
        completed: {
          border: {
            ...
            $value: "lch(47.04% 69.94 279.78)",
            $description:
              "Border color for completed pipeline states. Adjusted for protanopia using blue instead of green.",
            filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
            isSource: true,
            original: {
              $type: "color",
    ...
    sidebar: {
      ...
      logo: {
        ...
        icon: {
          ...
          $value: "lch(85.99% 3.77 285.34)",
          $description:
            "Icon color for Logo in sidebar navigation. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
    ...
    skeleton: {
      background: {
        $type: "color",
        $value:
          "linear-gradient(90deg, lch(85.99% 3.77 285.34) 0%, lch(100% 0 134.54) 50%, lch(85.99% 3.77 285.34) 100%)",
        $description:
    ...
    slider: {
      track: {
        ...
        progress: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Filled portion color for slider tracks. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      "track-segments": {
        ...
        progress: {
          ...
          $value: "lch(27.25% 49.8 280.51)",
          $description:
            "Color for segment markers on the filled track portion. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
    ...
    "status-indicator": {
      completed: {
        ...
        $value: "lch(47.04% 69.94 279.78)",
        $description:
          "Color for success status indicators. Adjusted for protanopia using blue instead of green.",
        filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
        isSource: true,
        original: {
          $type: "color",
    ...
    switch: {
      ...
      selected: {
        ...
        background: {
          ...
          $value: "lch(35.67% 59.7 280.58)",
          $description:
            "Background color for the selected state of switch controls. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
    ...
    tag: {
      ...
      green: {
        text: {
          ...
          $value: "lch(27.25% 49.8 280.51)",
          $description:
            "Text color for green tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for green tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for green tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for green tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      lime: {
        text: {
          ...
          $value: "lch(27.25% 49.8 280.51)",
          $description:
            "Text color for lime tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for lime tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for lime tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for lime tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      mint: {
        text: {
          ...
          $value: "lch(27.25% 49.8 280.51)",
          $description:
            "Text color for mint tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for mint tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for mint tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for mint tags. Adjusted for protanopia using blue instead of green.",
          filePath: "design-tokens/mode/light/high-contrast-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
  ...
  shadow: {
    0: {
      $type: "shadow",
      $value: "0 0 0 0 lch(from var(--cn-colors-chrome-950) l c h / 0)",
      $description:
    ...
    1: {
      $type: "shadow",
      $value: "0 1px 2px 0 lch(from var(--cn-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    2: {
      $type: "shadow",
      $value:
        "0 1px 3px 0 lch(from var(--cn-colors-chrome-950) l c h / 0.6), 0 1px 2px -1px lch(from var(--cn-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    3: {
      $type: "shadow",
      $value:
        "0 4px 6px -1px lch(from var(--cn-colors-chrome-950) l c h / 0.5), 0 2px 4px -2px lch(from var(--cn-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    4: {
      $type: "shadow",
      $value:
        "0 10px 15px -3px lch(from var(--cn-colors-chrome-950) l c h / 0.5), 0 4px 6px -4px lch(from var(--cn-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    5: {
      $type: "shadow",
      $value:
        "0 20px 25px -5px lch(from var(--cn-colors-chrome-950) l c h / 0.5), 0 8px 10px -6px lch(from var(--cn-colors-chrome-950) l c h / 0.5)",
      $description:
    ...
    6: {
      $type: "shadow",
      $value:
        "0 25px 50px -12px lch(from var(--cn-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    inner: {
      $type: "shadow",
      $value:
        "inset 0 2px 4px 0 lch(from var(--cn-colors-chrome-950) l c h / 0.1)",
      $description:
  ...
  "shadow-color": {
    0: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-950) l c h / 0)",
      $description:
    ...
    1: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-950) l c h / 0.6)",
      $description:
    ...
    inner: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-950) l c h / 0.1)",
      $description:
