 ...
 * Generated on Wed, 19 Mar 2025 07:15:51 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/dark/default-tritanopia.json",
      isSource: true,
      original: {
        $type: "color",
    ...
    badge: {
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(90.23% 26.34 77.18) 0%, lch(72% 46.72 350.11) 35%, lch(63.38% 78.04 52.26) 65%, lch(74.15% 29 241) 100%)",
          $description:
