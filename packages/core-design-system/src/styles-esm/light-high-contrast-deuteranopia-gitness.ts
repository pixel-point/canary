 ...
 * Generated on Wed, 19 Mar 2025 07:15:59 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/high-contrast-deuteranopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-400) l c h / 0.1)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-500) l c h / 0.2)",
          $description:
    ...
    badge: {
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-cyan-400) l c h / 0.6)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-cyan-300) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(54.81% 69.74 52.27) 35%, lch(56.15% 44.5 246.5) 65%, lch(65.49% 45.28 239) 100%)",
          $description:
      ...
      outline: {
        ...
        unselected: {
          text: {
            ...
            filePath:
              "design-tokens/mode/light/high-contrast-deuteranopia.json",
            isSource: true,
            original: {
              $type: "color",
              $value: "{text.2}",
      ...
      success: {
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-cyan-300) l c h / 0.15)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-cyan-300) l c h / 0.25)",
            $description:
      ...
      danger: {
        ...
        state: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-orange-300) l c h / 0.25)",
            $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-cyan-400) l c h / 0.12)",
        $description:
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-cyan-400) l c h / 0.2)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-cyan-400) l c h / 0.25)",
        $description:
      ...
      "del-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-orange-400) l c h / 0.12)",
        $description:
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-orange-400) l c h / 0.25)",
        $description:
