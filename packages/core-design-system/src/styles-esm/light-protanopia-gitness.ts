...
export default {
  ...
  component: {
    ...
    badge: {
      ...
      neutral: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-600) l c h / 0.2)",
          $description:
      ...
      success: {
        text: {
          ...
          $value: "lch(35.67% 59.7 280.58)",
          $description:
            "Text color for success badges. Communicates positive status through readable blue text. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $description:
            "Border color for success badges. Provides subtle definition for success state indicators. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        background: {
          ...
          $description:
            "Background color for success badges. Creates a subtle but recognizable success indicator. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-400) l c h / 0.2)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-400) l c h / 0.2)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-400) l c h / 0.2)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(61.26% 69.37 350) 35%, lch(61.28% 80.51 307.53) 65%, lch(74.15% 29 241) 100%)",
          $description:
    ...
    btn: {
      ...
      success: {
        text: {
          ...
          $value: "lch(35.67% 59.7 280.58)",
          $description:
            "Text color for success buttons. Communicates positive actions through readable blue text. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.12)",
          $description:
            "Background color for success buttons. Creates subtle but recognizable positive action styling. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        border: {
          ...
          $description:
            "Border color for success buttons. Provides definition for positive action buttons. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        state: {
          hover: {
            ...
            $description:
              "Hover state background color for success buttons. Creates subtle feedback for user interaction. Adjusted for protanopia visibility.",
            filePath: "design-tokens/mode/light/default-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
          ...
          active: {
            ...
            $description:
              "Active state background color for success buttons. Provides stronger visual feedback for clicks/presses. Adjusted for protanopia visibility.",
            filePath: "design-tokens/mode/light/default-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-300) l c h / 0.12)",
          $description:
    ...
    diff: {
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-500) l c h / 0.25)",
        $description:
      ...
      arrow: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "linear-gradient(90deg, lch(90.71% 0.38 284.93) 0%, lch(54.29% 60.55 281.11) 50%, lch(26.73% 7.48 287.06) 100%)",
            $description:
      ...
      card: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "radial-gradient(604% 142% at 0% 0%, lch(63.38% 78.04 52.26) 0%, lch(from var(--cn-colors-chrome-200) l c h / 0.4) 30%, lch(63.38% 78.04 52.26) 100%)",
            $description:
  ...
  shadow: {
    ...
    1: {
      $type: "shadow",
      $value: "0 1px 2px 0 lch(from var(--cn-colors-chrome-300) l c h / 0.6)",
      $description:
    ...
    2: {
      $type: "shadow",
      $value:
        "0 1px 3px 0 lch(from var(--cn-colors-chrome-300) l c h / 0.6), 0 1px 2px -1px lch(from var(--cn-colors-chrome-300) l c h / 0.6)",
      $description:
    ...
    3: {
      $type: "shadow",
      $value:
        "0 4px 6px -1px lch(from var(--cn-colors-chrome-300) l c h / 0.5), 0 2px 4px -2px lch(from var(--cn-colors-chrome-300) l c h / 0.5)",
      $description:
    ...
    4: {
      $type: "shadow",
      $value:
        "0 10px 15px -3px lch(from var(--cn-colors-chrome-300) l c h / 0.5), 0 4px 6px -4px lch(from var(--cn-colors-chrome-300) l c h / 0.5)",
      $description:
    ...
    5: {
      $type: "shadow",
      $value:
        "0 20px 25px -5px lch(from var(--cn-colors-chrome-300) l c h / 0.5), 0 8px 10px -6px lch(from var(--cn-colors-chrome-300) l c h / 0.5)",
      $description:
    ...
    6: {
      $type: "shadow",
      $value:
        "0 25px 50px -12px lch(from var(--cn-colors-chrome-300) l c h / 0.6)",
      $description:
    ...
    inner: {
      $type: "shadow",
      $value:
        "inset 0 2px 4px 0 lch(from var(--cn-colors-chrome-900) l c h / 0.1)",
      $description:
  ...
  "shadow-color": {
    ...
    inner: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-900) l c h / 0.1)",
      $description:
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value:
        "0 0 0 2px lch(98.27% 0.36 135.2), 0 0 0 4px lch(8.25% 4.49 287.18)",
      $description:
    ...
    pipeline: {
      running: {
        ...
        "gradient-stop-2": {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-200) l c h / 0.4)",
          filePath: "design-tokens/mode/light/default-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
