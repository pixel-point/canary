 ...
 * Generated on Wed, 19 Mar 2025 07:16:01 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/dimmer-tritanopia.json",
      isSource: true,
      original: {
        $type: "color",
    ...
    badge: {
      ...
      warning: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-200) l c h / 0.07)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(74.82% 51.93 49.87) 0%, lch(61.26% 69.37 350) 35%, lch(65.49% 45.28 239) 65%, lch(74.15% 29 241) 100%)",
          $description:
