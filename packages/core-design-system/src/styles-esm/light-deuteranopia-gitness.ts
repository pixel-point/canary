...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/default-deuteranopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    badge: {
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(61.26% 69.37 350) 35%, lch(65.49% 45.28 239) 65%, lch(74.15% 29 241) 100%)",
          $description:
    ...
    btn: {
      ...
      success: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-cyan-200) l c h / 0.12)",
          $description:
        ...
        state: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-cyan-200) l c h / 0.25)",
            $description:
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-300) l c h / 0.12)",
          $description:
    ...
    diff: {
      ...
      "del-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-orange-500) l c h / 0.25)",
        $description:
