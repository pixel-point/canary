...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/high-contrast-tritanopia.json",
      isSource: true,
      original: {
        $type: "color",
    ...
    badge: {
      ...
      warning: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-200) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(74.82% 51.93 49.87) 0%, lch(53.21% 65.17 349.99) 35%, lch(56.15% 44.5 246.5) 65%, lch(65.49% 45.28 239) 100%)",
          $description:
        ...
        delete: {
          ...
          state: {
            hover: {
              ...
              filePath:
                "design-tokens/mode/light/high-contrast-tritanopia.json",
              isSource: true,
              original: {
                $extensions: {
                  "studio.tokens": {
    ...
    tag: {
      ...
      yellow: {
        text: {
          ...
          $value: "lch(27.78% 46.26 47.39)",
          $description:
            "Text color for yellow tags. Signals caution states with readable amber text.",
          filePath: "design-tokens/mode/light/high-contrast-tritanopia.json",
          isSource: true,
          original: {
            $type: "color",
