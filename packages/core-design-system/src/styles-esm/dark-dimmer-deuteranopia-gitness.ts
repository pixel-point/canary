 ...
 * Generated on Wed, 19 Mar 2025 07:15:49 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/dark/dimmer-deuteranopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        title: {
          ...
          $description:
            "Text color for danger alerts. Communicates critical information through high-contrast text.",
          filePath: "design-tokens/mode/dark/dimmer-deuteranopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-300) l c h / 0.2)",
          $description:
    ...
    badge: {
      ...
      neutral: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.2)",
          $description:
      ...
      success: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-cyan-300) l c h / 0.2)",
          $description:
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-300) l c h / 0.2)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-500) l c h / 0.1)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(90.23% 26.34 77.18) 0%, lch(74.82% 51.93 49.87) 35%, lch(65.49% 45.28 239) 65%, lch(74.15% 29 241) 100%)",
          $description:
      ...
      arrow: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "linear-gradient(90deg, lch(90.71% 0.38 284.93) 0%, lch(63.4% 48.44 281.2) 50%, lch(58.08% 6.76 286.02) 100%)",
            $description:
    ...
    "status-indicator": {
      completed: {
        ...
        $description:
          "Color for success status indicators. Communicates completed or positive states using cyan for deuteranopia accessibility.",
        filePath: "design-tokens/mode/dark/dimmer-deuteranopia.json",
        isSource: true,
        original: {
          $type: "color",
      ...
      cancelled: {
        ...
        $description:
          "Color for danger status indicators. Communicates error or critical warning states using orange for deuteranopia accessibility.",
        filePath: "design-tokens/mode/dark/dimmer-deuteranopia.json",
        isSource: true,
        original: {
          $type: "color",
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value:
        "0 0 0 2px lch(2.44% 1.49 285.81), 0 0 0 4px lch(85.99% 3.77 285.34)",
      $description:
