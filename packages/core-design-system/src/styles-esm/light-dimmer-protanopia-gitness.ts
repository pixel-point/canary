 ...
 * Generated on Wed, 19 Mar 2025 07:15:56 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  border: {
    ...
    2: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-100) l c h / 0.8)",
      $description:
  ...
  state: {
    hover: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-400) l c h / 0.1)",
      $description:
    ...
    selected: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-400) l c h / 0.15)",
      $description:
  ...
  component: {
    ...
    alert: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-500) l c h / 0.08)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-400) l c h / 0.15)",
          $description:
    ...
    badge: {
      ...
      neutral: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-500) l c h / 0.07)",
          $description:
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-600) l c h / 0.3)",
          $description:
      ...
      success: {
        text: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Text color for success badges. Communicates positive status through readable blue text. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.3)",
          $description:
            "Border color for success badges. Provides subtle definition for success state indicators. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-200) l c h / 0.07)",
          $description:
            "Background color for success badges. Creates a subtle but recognizable success indicator. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
      ...
      danger: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-300) l c h / 0.07)",
          $description:
      ...
      warning: {
        text: {
          ...
          $value: "lch(46.64% 52.59 77.11)",
          $description:
            "Text color for warning badges. Signals caution states with readable amber text.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-200) l c h / 0.07)",
          $description:
      ...
      running: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-orange-300) l c h / 0.07)",
          $description:
      ...
      merged: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-purple-300) l c h / 0.07)",
          $description:
      ...
      ai: {
        ...
        border: {
          $type: "color",
          $value:
            "linear-gradient(94deg, lch(73.82% 74.92 75.35) 0%, lch(61.26% 69.37 350) 35%, lch(61.28% 80.51 307.53) 65%, lch(65.49% 45.28 239) 100%)",
          $description:
    ...
    btn: {
      ...
      success: {
        text: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Text color for success buttons. Communicates positive actions through readable blue text. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-200) l c h / 0.08)",
          $description:
            "Background color for success buttons. Creates subtle but recognizable positive action styling. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        border: {
          ...
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.3)",
          $description:
            "Border color for success buttons. Provides definition for positive action buttons. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-blue-200) l c h / 0.1)",
            $description:
              "Hover state background color for success buttons. Creates subtle feedback for user interaction. Using blue instead of green for protanopia visibility.",
            filePath: "design-tokens/mode/light/dimmer-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-blue-200) l c h / 0.15)",
            $description:
              "Active state background color for success buttons. Provides stronger visual feedback for clicks/presses. Using blue instead of green for protanopia visibility.",
            filePath: "design-tokens/mode/light/dimmer-protanopia.json",
            isSource: true,
            original: {
              $extensions: {
      ...
      danger: {
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-red-300) l c h / 0.08)",
          $description:
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-red-300) l c h / 0.1)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-red-300) l c h / 0.15)",
            $description:
    ...
    dialog: {
      ...
      backdrop: {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
        $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-500) l c h / 0.08)",
        $description:
          "Blue background highlighting newly added code lines while maintaining readability. Using blue instead of green for protanopia visibility.",
        filePath: "design-tokens/mode/light/dimmer-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "add-lineNumber": {
        ...
        $description:
          "Background for line numbers of added code, providing visual connection to added content. Using blue instead of green for protanopia visibility.",
        filePath: "design-tokens/mode/light/dimmer-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-blue-500) l c h / 0.15)",
        $description:
          "Stronger emphasis color for specific character changes within added lines. Using blue instead of green for protanopia visibility.",
        filePath: "design-tokens/mode/light/dimmer-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
    ...
    pipeline: {
      arrow: {
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "linear-gradient(90deg, lch(90.71% 0.38 284.93) 0%, lch(54.29% 60.55 281.11) 50%, lch(46.46% 7.5 286.37) 100%)",
            $description:
      ...
      card: {
        background: {
          $type: "color",
          $value:
            "radial-gradient(90% 100% at 15% 0%,lch(100% 0 134.54) 10%, lch(98.27% 0.36 135.2) 75%)",
          $description:
        ...
        border: {
          $type: "color",
          $value:
            "radial-gradient(90% 100% at 15% 0%,lch(98.27% 0.36 135.2) 10%, lch(90.71% 0.38 284.93) 75%)",
          $description:
        ...
        running: {
          border: {
            $type: "color",
            $value:
              "radial-gradient(604% 142% at 0% 0%, lch(63.38% 78.04 52.26) 0%, lch(from var(--cn-colors-chrome-200) l c h / 0.3) 30%, lch(63.38% 78.04 52.26) 100%)",
            $description:
        ...
        completed: {
          border: {
            ...
            $value: "lch(63.4% 48.44 281.2)",
            $description:
              "Border color for completed pipeline states. Indicates successful pipeline execution. Using blue instead of green for protanopia visibility.",
            filePath: "design-tokens/mode/light/dimmer-protanopia.json",
            isSource: true,
            original: {
              $type: "color",
      ...
      background: {
        dotes: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.5)",
          $description:
    ...
    sidebar: {
      ...
      hover: {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-chrome-700) l c h / 0.15)",
      ...
      selected: {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-chrome-700) l c h / 0.2)",
    ...
    skeleton: {
      background: {
        $type: "color",
        $value:
          "linear-gradient(90deg, lch(90.71% 0.38 284.93) 0%, lch(100% 0 134.54) 50%, lch(90.71% 0.38 284.93) 100%)",
        $description:
    ...
    "status-indicator": {
      completed: {
        ...
        $value: "lch(63.4% 48.44 281.2)",
        $description:
          "Color for success status indicators. Communicates completed or positive states. Using blue instead of green for protanopia visibility.",
        filePath: "design-tokens/mode/light/dimmer-protanopia.json",
        isSource: true,
        original: {
          $type: "color",
    ...
    table: {
      ...
      row: {
        "alternate-background": {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-200) l c h / 0.07)",
          $description:
    ...
    tag: {
      ...
      green: {
        text: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Text color for green tags. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for green tags. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for green tags. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for green tags. Using blue instead of green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      lime: {
        text: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Text color for lime tags. Using blue instead of lime/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for lime tags. Using blue instead of lime/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for lime tags. Using blue instead of lime/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for lime tags. Using blue instead of lime/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      mint: {
        text: {
          ...
          $value: "lch(47.04% 69.94 279.78)",
          $description:
            "Text color for mint tags. Using blue instead of mint/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Background color for mint tags. Using blue instead of mint/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(95.27% 4.16 280.86)",
          $description:
            "Subtle background variation for mint tags. Using blue instead of mint/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $value: "lch(89.92% 10.91 279.8)",
          $description:
            "Border color for mint tags. Using blue instead of mint/green for protanopia visibility.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      purple: {
        text: {
          ...
          $value: "lch(40.58% 118.62 311.84)",
          $description:
            "Text color for purple tags. Ensures readability while maintaining the purple color theme.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $description:
            "Background color for purple tags. Creates a distinct surface with purple theme styling.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $description:
            "Subtle background variation for purple tags. Provides a softer alternative for less emphasis.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      violet: {
        text: {
          ...
          $description:
            "Text color for violet tags. Ensures readability while maintaining the violet color theme.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $description:
            "Background color for violet tags. Creates a distinct surface with violet theme styling.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $description:
            "Subtle background variation for violet tags. Provides a softer alternative for less emphasis.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
      ...
      yellow: {
        text: {
          ...
          $description:
            "Text color for yellow tags. Ensures readability while maintaining the yellow color theme.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $description:
            "Background color for yellow tags. Creates a distinct surface with yellow theme styling.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $description:
            "Subtle background variation for yellow tags. Provides a softer alternative for less emphasis.",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
  ...
  shadow: {
    0: {
      $type: "shadow",
      $value: "0 0 0 0 lch(from var(--cn-colors-chrome-300) l c h / 0)",
      $description:
    ...
    1: {
      $type: "shadow",
      $value: "0 1px 2px 0 lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
    ...
    2: {
      $type: "shadow",
      $value:
        "0 1px 3px 0 lch(from var(--cn-colors-chrome-300) l c h / 0.4), 0 1px 2px -1px lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
    ...
    3: {
      $type: "shadow",
      $value:
        "0 4px 6px -1px lch(from var(--cn-colors-chrome-300) l c h / 0.35), 0 2px 4px -2px lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
    ...
    4: {
      $type: "shadow",
      $value:
        "0 10px 15px -3px lch(from var(--cn-colors-chrome-300) l c h / 0.35), 0 4px 6px -4px lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
    ...
    5: {
      $type: "shadow",
      $value:
        "0 20px 25px -5px lch(from var(--cn-colors-chrome-300) l c h / 0.35), 0 8px 10px -6px lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
    ...
    6: {
      $type: "shadow",
      $value:
        "0 25px 50px -12px lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
    ...
    inner: {
      $type: "shadow",
      $value:
        "inset 0 2px 4px 0 lch(from var(--cn-colors-chrome-900) l c h / 0.07)",
      $description:
  ...
  "shadow-color": {
    0: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0)",
      $description:
    ...
    1: {
      ...
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
        "Light shadow color with 40% opacity. Creates subtle depth for small UI elements.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    2: {
      ...
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
        "Medium shadow color with 40% opacity. Provides balanced depth for common UI components.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    3: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
        "Medium shadow color with 35% opacity. Creates moderate depth for elevated components.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    4: {
      ...
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
        "Deep shadow color with 35% opacity. Provides significant depth for floating elements.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    5: {
      ...
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.35)",
      $description:
        "Very deep shadow color with 35% opacity. Creates dramatic elevation for modal content.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    6: {
      ...
      $value: "lch(from var(--cn-colors-chrome-300) l c h / 0.4)",
      $description:
        "Extremely deep shadow color with 40% opacity. Provides maximum depth for highly elevated elements.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
    ...
    inner: {
      ...
      $type: "color",
      $value: "lch(from var(--cn-colors-chrome-900) l c h / 0.07)",
      $description:
        "Subtle inner shadow color with 7% opacity. Creates inset effect for pressed or focused states.",
      filePath: "design-tokens/mode/light/dimmer-protanopia.json",
      isSource: true,
      original: {
        $extensions: {
  ...
  ring: {
    focus: {
      $type: "shadow",
      $value: "0 0 0 2px lch(100% 0 134.54), 0 0 0 4px lch(8.25% 4.49 287.18)",
      $description:
    ...
    pipeline: {
      running: {
        ...
        "gradient-stop-2": {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-chrome-200) l c h / 0.3)",
          filePath: "design-tokens/mode/light/dimmer-protanopia.json",
          isSource: true,
          original: {
            $extensions: {
  ...
  brand: {
    color: {
      50: {
        $type: "color",
        $value: "lch(85.99% 3.77 285.34)",
        filePath: "design-tokens/brand/Gitness.json",
        isSource: true,
        original: {
          $type: "color",
          $value: "{colors.chrome.150}",
