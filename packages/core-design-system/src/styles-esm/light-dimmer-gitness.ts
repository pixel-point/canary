 ...
 * Generated on Wed, 19 Mar 2025 07:15:53 GMT
 * Copyright (c) Harness.
 */
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        text: {
          ...
          $value: "lch(48.21% 43.17 156.25)",
          $description:
            "Text color for success badges. Communicates positive status through readable green text.",
          filePath: "design-tokens/mode/light/dimmer.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-300) l c h / 0.3)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-200) l c h / 0.07)",
          $description:
    ...
    btn: {
      ...
      success: {
        text: {
          ...
          $value: "lch(48.21% 43.17 156.25)",
          $description:
            "Text color for success buttons. Communicates positive actions through readable green text.",
          filePath: "design-tokens/mode/light/dimmer.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-green-200) l c h / 0.08)",
          $description:
        ...
        state: {
          hover: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-green-200) l c h / 0.1)",
            $description:
          ...
          active: {
            ...
            $type: "color",
            $value: "lch(from var(--cn-colors-green-200) l c h / 0.15)",
            $description:
    ...
    diff: {
      ...
      "add-content": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-500) l c h / 0.08)",
        $description:
          "Green background highlighting newly added code lines while maintaining readability.",
        filePath: "design-tokens/mode/light/dimmer.json",
        isSource: true,
        original: {
          $extensions: {
      ...
      "add-lineNumber": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-500) l c h / 0.12)",
        $description:
      ...
      "add-content-highlight": {
        ...
        $type: "color",
        $value: "lch(from var(--cn-colors-green-500) l c h / 0.15)",
        $description:
    ...
    tag: {
      ...
      green: {
        text: {
          ...
          $description:
            "Text color for green tags. Ensures readability while maintaining the green color theme.",
          filePath: "design-tokens/mode/light/dimmer.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $description:
            "Background color for green tags. Creates a distinct surface with green theme styling.",
          filePath: "design-tokens/mode/light/dimmer.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $description:
            "Subtle background variation for green tags. Provides a softer alternative for less emphasis.",
          filePath: "design-tokens/mode/light/dimmer.json",
          isSource: true,
          original: {
            $type: "color",
