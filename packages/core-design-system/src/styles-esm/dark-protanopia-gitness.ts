 ...
 * Generated on Wed, 19 Mar 2025 07:15:46 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/dark/default-protanopia.json",
      isSource: true,
      original: {
        $type: "color",
  ...
  component: {
    ...
    badge: {
      ...
      success: {
        text: {
          ...
          $value: "lch(73.08% 34.81 281.21)",
          $description:
            "Text color for success badges. Communicates positive status through readable blue text.",
          filePath: "design-tokens/mode/dark/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-300) l c h / 0.2)",
          $description:
        ...
        background: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-blue-500) l c h / 0.1)",
          $description:
    ...
    btn: {
      ...
      success: {
        text: {
          ...
          $value: "lch(73.08% 34.81 281.21)",
          $description:
            "Text color for success buttons. Communicates positive actions through readable blue text.",
          filePath: "design-tokens/mode/dark/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
    ...
    diff: {
      ...
      "add-content": {
        ...
        $description:
          "Blue background highlighting newly added code lines while maintaining readability.",
        filePath: "design-tokens/mode/dark/default-protanopia.json",
        isSource: true,
        original: {
          $extensions: {
    ...
    tag: {
      ...
      green: {
        text: {
          ...
          $value: "lch(73.08% 34.81 281.21)",
          $description:
            "Text color for green tags. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/dark/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        background: {
          ...
          $value: "lch(9.63% 33.17 284.31)",
          $description:
            "Background color for green tags. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/dark/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
        ...
        "background-subtle": {
          ...
          $value: "lch(2.52% 22.28 283.9)",
          $description:
            "Subtle background variation for green tags. Adjusted for protanopia visibility.",
          filePath: "design-tokens/mode/dark/default-protanopia.json",
          isSource: true,
          original: {
            $type: "color",
