 ...
 * Generated on Wed, 19 Mar 2025 07:15:50 GMT
 * Copyright (c) Harness.
 */
...
export default {
  background: {
    1: {
      ...
      filePath: "design-tokens/mode/dark/high-contrast-deuteranopia.json",
      isSource: true,
      original: {
        $type: "color",
    ...
    badge: {
      ...
      warning: {
        ...
        border: {
          ...
          $type: "color",
          $value: "lch(from var(--cn-colors-yellow-300) l c h / 0.6)",
          $description:
        ...
        delete: {
          ...
          state: {
            hover: {
              ...
              filePath:
                "design-tokens/mode/dark/high-contrast-deuteranopia.json",
              isSource: true,
              original: {
                $extensions: {
                  "studio.tokens": {
