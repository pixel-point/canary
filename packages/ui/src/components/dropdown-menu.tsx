...
>(({ className, insideSplitButton, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Trigger
    ref={ref}
    className={cn(
      'group outline-none [&>svg.chevron-down]:duration-100 [&>svg.chevron-down]:ease-in-out [&>svg.chevron-down]:data-[state=open]:rotate-180 transition-colors',
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="border-cn-borders-9 absolute left-2 flex size-4 items-center justify-center rounded-sm border group-data-[state=checked]:border-icons-2">
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn('bg-borders-1 -mx-1 my-1 h-px', className)} {...props} />
))
