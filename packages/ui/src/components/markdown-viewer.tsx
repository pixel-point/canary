...
const MarkdownViewerWrapper = ({ children }: MarkdownViewerWrapperProps) => {
...
// TODO: moved this component from packages/views, and it needs to be refactored.
export function MarkdownViewer({
  ...
  const styles: CSSProperties = maxHeight
    ? {
        maxHeight: maxHeight
      }
    : {}
  ...
  return (
    <Wrapper>
      ...
      >
        <MarkdownPreview
          source={source}
          className="prose prose-invert !max-w-full !bg-background-1"
